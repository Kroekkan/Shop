...
$productIds = [];
foreach($_SESSION['cart'] ?? []) as $cartId => $scarQty) {
    $productIds[] = $cartId;
}

$ids = 0;
id(count(productIds) > 0) {
                    ...
                    <table class="table table-bordered border-info">
                        ...
                        <tbody>
                            <?php if($rows > 0): ?>
                                ...
                                <tr>
                                    <td>
                                        <?php if(!empty($product['prodile_image'])): ?>
                                            <img src="<?php echo $base_url; ?>/upload_inage/<?php echo $product['prodile_image']; ?>" width="100" alt="product Image">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Are you want to delete?');" role="button" href="<?php echo $base_url; ?>/cart-delete.php?id=<?php echo $product['id'] ?>" class="btn btn-outline-danger"><i class="fa-slid fa-trash me-1"></i>Delete</a>
                                    </td>
                                </tr>
                                
                                <?php endwhile; ?>
                                <tr>
                                    <td colspan="6" class="test-endd">
                                        <button type=submit" class="btn btn-lg btn-success">Update Cart</button>
                                        <a href="<?php echo $base_url; ?>/checkout.php" class="btn btn-lg btn-success">Checkout Order</button>
                                    </td>
                                </tr>
                            <?php else: ?>></a>
                                    </td>
